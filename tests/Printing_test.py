...
@pytest.mark.printing
@pytest.mark.parametrize('set1, set2, expect', [
    ('2302-02-13', '%Y-%m-%d', True),
    ('2002-12-13', '%Y-%m-%d', True),
    ('2012-25-03', '%Y-%d-%m', True),
    ('2012-25-13', '%Y-%d-%m', False),
    ('2012-05-03', '%Y-%d-%m', True),
    ('05-03-2012', '%d-%m-%Y', True),
    ('15-03-2112', '%d-%m-%Y', True),
    ('05-13-2012', '%d-%m-%Y', False),
])
def test_isValidDate(set1, set2, expect):
    assert PrintingCharts.is_valid_date(set1, set2) == expect
...
def test_getMonthFromValue(set, expect):
    assert PrintingCharts.getMonthFromValue(set) == expect

@pytest.mark.printing
@pytest.mark.parametrize('set1, set2, expect', [
    (
        ['02-02-2012', '03-02-2012','04-02-2012','05-02-2012','12-02-2012','15-02-2012','1-03-2012','02-03-2012'
         ,'05-03-2012','18-03-2012','20-03-2012','01-04-2012','02-04-2012'], 
        None,
        '  02 | 03 | |'
    ),
    (
        ['02-02-2012', '03-02-2012','04-02-2012','05-02-2012','12-02-2012','15-02-2012',
         '17-02-2012', '18-02-2012','19-02-2012','20-02-2012','21-02-2012','22-02-2012',
         '23-02-2012', '24-02-2012','25-02-2012','26-02-2012','27-02-2012','28-02-2012',
         '1-03-2012','02-03-2012','05-03-2012','18-03-2012','20-03-2012','01-04-2012','02-04-2012'], 
        None,
        '              02 | 03 | |'
    ),
    (
...
def test_groupChartValuesByMonthes(set1, set2, expect):
    assert PrintingCharts.groupChartValuesByMonthes(set1, set2) == expect
